...
export type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is user::User]": $.LinkDesc<_user.$User, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<__type__[is integration::BaseIntegration]": $.LinkDesc<_integration.$BaseIntegration, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is integration::PicnicIntegration]": $.LinkDesc<_integration.$PicnicIntegration, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is integration::TrelloIntegration]": $.LinkDesc<_integration.$TrelloIntegration, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is userIntegration::UserIntegration]": $.LinkDesc<_userIntegration.$UserIntegration, $.Cardinality.Many, {}, false, false,  false, false>;
